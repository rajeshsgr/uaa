package com.nola.raj.uaa.repository;

import com.nola.raj.uaa.UaaApp;
import com.nola.raj.uaa.config.Constants;
import com.nola.raj.uaa.config.audit.AuditEventConverter;
import com.nola.raj.uaa.domain.PersistentAuditEvent;
...
import static com.nola.raj.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
